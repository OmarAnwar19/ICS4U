...
public class Anwar2DArraysEx2 {
	...
	public static void getSum(byte[][] grid, byte bytRow) {

		// declare variable to store the sum of the row
		short shrSum = 0;

		//for loop to add up all of the values of the row
		for (int i = 0; i < grid.length; i++) {

			//adding the value of i, in the user's selected row, to the shrSum variable
			shrSum += grid[bytRow - 1][i];

		}

		//outputting a message with the sum
		System.out.println("\nSum of row " + bytRow + ": " + shrSum);
	...
	public static void main(String[] args) {
		...
		do {
			...
			try {
				...
				System.out.print("\nWhich row would you like to add up?: ");
