...
public class AnwarAssignment1RPSBACKUP {
	...
	public static void dispInstruct() {
		...
		int intMenuChoice = JOptionPane.showOptionDialog(null, "Welcome to the game Rock, Paper, Scissors!", "Rock, Paper, Scissors!", 0,
				JOptionPane.INFORMATION_MESSAGE, null, strInstructionsMenu, null);
	...
	public static void gameMethod() {
		...
		bytCompChoice = (byte) ((Math.random() * (4 - 1)) + 1);
		...
		if (bytUserChoice == 1 && bytCompChoice == 1) {
			...
			JOptionPane.showMessageDialog(null, "USER CHOICE: Rock\n" + "COMPUTER CHOICE: Rock\n\n" + "IT'S A DRAW!",
			...
			// display a message box to the user with this outcome
			JOptionPane.showMessageDialog(null, "USER CHOICE: Paper\n" + "COMPUTER CHOICE: Paper\n\n" + "IT'S A DRAW!",
					"Rock, Paper, Scissors!", JOptionPane.QUESTION_MESSAGE);
		...
		if (bytUserChoice == 1 && bytCompChoice == 3) {
			...
			// display a message box to the user with this outcome
			JOptionPane.showMessageDialog(null, "USER CHOICE: Scissors\n" + "COMPUTER CHOICE: Rock\n\n" + "YOU WIN!",
					"Rock, Paper, Scissors!", JOptionPane.QUESTION_MESSAGE);
